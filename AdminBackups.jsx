...
export default function AdminBackups() {
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold font-heading text-gray-900">Backups</h1>
        <p className="text-sm text-gray-500 mt-1">Database & media backups, restore points, scheduled snapshots.</p>
      </div>
