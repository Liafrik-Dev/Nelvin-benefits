...
export default function AdminRoles() {
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold font-heading text-gray-900">Admin Roles & Permissions</h1>
        <p className="text-sm text-gray-500 mt-1">Available roles and per-role permission customization.</p>
      </div>
          ...
          <div key={r.name} className="bg-white rounded-2xl border border-gray-100 p-5">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">{r.ceiling}</p>
              </div>
            </div>
