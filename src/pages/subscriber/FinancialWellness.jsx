    ...
    <div className="min-h-screen bg-forest">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        <div className="bg-emerald-black ring-1 ring-white/10 rounded-xl p-6 sm:p-8 shadow-sm flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="bg-[#062B23] text-[#D6B56D] p-5 rounded-lg text-center min-w-[220px]">
            ...
            <form onSubmit={handleAdvanceRequest} className="space-y-4">
              <div>
                <div className="flex justify-between text-xs font-bold text-ivory mb-2">
                  ...
                  <span className="text-[#D6B56D]">${requestedAmount}</span>
                </div>
                <input
                  type="range"
                  min="50"
              ...
              <div className="p-4 bg-forest-secondary/60 rounded-lg border border-white/10 text-xs space-y-2">
              ...
              <button
                type="submit"
                className="w-full bg-[#062B23] text-[#D6B56D] font-bold py-3.5 rounded-full text-xs hover:bg-[#062B23] transition-colors shadow-sm"
              >
                Transfer ${requestedAmount} Now
              </button>
              {submitted && (
                <p className="text-xs font-bold text-[#D6B56D] text-center">
