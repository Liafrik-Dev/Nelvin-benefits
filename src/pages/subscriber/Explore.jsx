      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-10">
        <div className="bg-emerald-black ring-1 ring-[#F1F1F1] rounded-xl p-6 sm:p-8 shadow-sm flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="space-y-3 max-w-xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#FFFFFF] text-[#1B4F9C] text-xs font-bold uppercase tracking-wider">
              <Sparkles className="w-3.5 h-3.5 text-[#1B4F9C]" /> Curated Lifestyle Perks
            </div>
          ...
          <div className="flex flex-wrap gap-3">
            <Link to="/marketplace" className="bg-[#FFFFFF] text-[#1B4F9C] font-bold px-5 py-3 rounded-full text-sm hover:bg-[#FFFFFF] transition-colors flex items-center gap-2">
              Browse Marketplace <ArrowRight className="w-4 h-4" />
            </Link>
            <Link to="/nearby" className="bg-[#FFFFFF] text-[#1B4F9C] font-bold px-5 py-3 rounded-full text-sm hover:bg-[#FFFFFF] transition-colors">
              Find Nearby
            </Link>
          </div>
        </div>
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Award className="w-5 h-5 text-[#1B4F9C]" />
              <h2 className="text-xl font-bold text-ivory font-heading">Featured & VIP Deals</h2>
            </div>
            <Link to="/marketplace?filter=featured" className="text-xs font-bold text-[#1B4F9C] hover:underline">View All</Link>
          </div>
          {loading ? (
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Flame className="w-5 h-5 text-[#1B4F9C]" />
              <h2 className="text-xl font-bold text-ivory font-heading">Trending Right Now</h2>
            </div>
            <Link to="/marketplace?filter=trending" className="text-xs font-bold text-[#1B4F9C] hover:underline">View All</Link>
          </div>
          {loading ? (
            <div className="h-48 flex items-center justify-center text-ivory-dim">Loading recommendations...</div>
          ) : (
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <TrendingUp className="w-5 h-5 text-[#1B4F9C]" />
              <h2 className="text-xl font-bold text-ivory font-heading">High Cashback Perks</h2>
            </div>
            <Link to="/cashback" className="text-xs font-bold text-[#1B4F9C] hover:underline">View Cashback</Link>
          </div>
          {loading ? (
