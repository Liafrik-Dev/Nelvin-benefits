      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        <div>
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#FFFFFF] text-[#1B4F9C] text-xs font-bold uppercase">
            <HelpCircle className="w-3.5 h-3.5 text-[#1B4F9C]" /> Help & Support Desk
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-emerald-black ring-1 ring-[#F1F1F1] rounded-xl p-6 sm:p-8 shadow-sm space-y-4">
            <div className="flex items-center gap-2 font-bold text-ivory font-heading text-lg">
              <MessageSquare className="w-5 h-5 text-[#1B4F9C]" /> Submit a Ticket
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-[#FFFFFF] text-[#1B4F9C] font-bold py-3 rounded-full text-xs hover:bg-[#FFFFFF] transition-colors shadow-sm flex items-center justify-center gap-2"
              >
                <Send className="w-3.5 h-3.5" /> Send Ticket
              </button>
              {submitted && (
                <div className="p-3 bg-[#FFFFFF] text-[#1B4F9C] rounded-xl text-xs font-bold text-center flex items-center justify-center gap-1.5">
                  <CheckCircle2 className="w-4 h-4 text-[#1B4F9C]" /> Support ticket created!
                </div>
              )}
            </form>
          </div>
