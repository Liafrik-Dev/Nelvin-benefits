      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="flex flex-wrap gap-3 mb-8">
          <select
            ...
            className="border border-gray-200 rounded-full px-4 py-2 text-sm bg-white outline-none"
          >
        ...
        {loading ? (
          ...
          <div className="text-center py-20 text-gray-400">No offers match your filters.</div>
        ) : (
