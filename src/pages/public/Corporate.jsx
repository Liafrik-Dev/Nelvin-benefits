...
const perks = [
  { title: "Employee Happiness", desc: "Improve satisfaction with rewards your team actually uses.", icon: Heart, bg: "bg-[#0866FF]", fg: "text-[#282828]" },
  { title: "Talent Attraction", desc: "Stand out during recruitment with a premium lifestyle benefits package.", icon: Users, bg: "bg-[#F4F4F4]", fg: "text-[#0866FF]" },
  { title: "Employee Retention", desc: "Increase loyalty and reduce churn with daily, real-world value.", icon: ShieldCheck, bg: "bg-[#0866FF]", fg: "text-[#282828]" },
  { title: "Exclusive Savings", desc: "Help employees save money on dining, travel, shopping, and wellness.", icon: Sparkles, bg: "bg-[#0866FF]", fg: "text-[#282828]" },
];
...
const whyCards = [
  { title: "Employee Benefits", desc: "Reward employees with thousands of exclusive offers across Africa.", icon: Heart, bg: "bg-[#0866FF]", fg: "text-[#282828]" },
  { title: "HR Dashboard", desc: "Track savings and engagement across departments in real time.", icon: LayoutDashboard, bg: "bg-[#F4F4F4]", fg: "text-[#0866FF]" },
  { title: "Real-Time Analytics", desc: "Know exactly who is using benefits and where to invest.", icon: Sparkles, bg: "bg-[#0866FF]", fg: "text-[#282828]" },
  { title: "Global Offers", desc: "Benefits available across every African country — and growing.", icon: Users, bg: "bg-[#0866FF]", fg: "text-[#282828]" },
  { title: "Corporate Billing", desc: "One invoice, unlimited employees, single monthly cycle.", icon: ShieldCheck, bg: "bg-[#F4F4F4]", fg: "text-[#0866FF]" },
  { title: "Dedicated Support", desc: "Email our corporate team directly during onboarding and beyond.", icon: Phone, bg: "bg-[#0866FF]", fg: "text-[#282828]" },
];
    ...
    <div className="min-h-screen bg-forest">
      <div className="relative bg-[#FFFFFF] overflow-hidden">
        ...
        {isHRAdmin ? (
          ...
          >
            <div className="absolute -top-20 -right-20 w-80 h-80 bg-[#0866FF]/30 rounded-full blur-3xl" />
            <div className="absolute -bottom-24 -left-20 w-80 h-80 bg-[#0866FF]/20 rounded-full blur-3xl" />
            <div className="relative max-w-4xl mx-auto text-center">
              {company?.logo_url || company?.branding_logo_url ? (
                ...
                <div className="w-16 h-16 rounded-xl bg-[#0866FF] flex items-center justify-center mx-auto mb-5 text-white font-bold text-2xl">
                  {(company?.name || "N").slice(0, 1)}
                </div>
              )}
              <span className="text-[#0866FF] font-semibold text-xs tracking-[0.2em] uppercase">Welcome back</span>
              <motion.h1
              ...
              >
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-[#0866FF] hover:bg-[#0866FF] text-white font-semibold px-7 py-3.5 rounded-full text-sm transition-colors"
                >
          ...
          >
            ...
            <div className="absolute -bottom-24 -left-20 w-80 h-80 bg-[#0866FF]/20 rounded-full blur-3xl" />
            <div className="relative max-w-4xl mx-auto text-center">
              <span className="text-[#0866FF] font-semibold text-xs tracking-[0.2em] uppercase">Nelvin for Business</span>
              <motion.h1
                initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.15 }}
              ...
              >
                ...
                <Link to="/corporate-signup" className="inline-flex items-center justify-center gap-2 bg-[#0866FF] hover:bg-[#0866FF] text-white font-semibold px-7 py-3.5 rounded-full text-sm transition-colors">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-6">
            {demoLogos.map((l) => (
              <div key={l} className="flex items-center gap-2 text-ivory-dim font-semibold text-sm">
                <div className="w-8 h-8 rounded-lg bg-[#F4F4F4] text-[#0866FF] ring-1 ring-[#0866FF]/25 flex items-center justify-center font-bold text-xs">{l.slice(0, 1)}</div>
                {l}
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-[#0866FF] font-semibold text-xs tracking-[0.15em] uppercase">Why Companies Choose Nelvin</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {whyCards.map((p) => (
              <div key={p.title} className="bg-emerald-black rounded-lg ring-1 ring-[#F1F1F1] p-7 hover:ring-[#0866FF]/30 transition-all">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-forest">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-[#0866FF] font-semibold text-xs tracking-[0.15em] uppercase">How It Works</p>
            <h2 className="text-3xl sm:text-4xl font-bold font-heading text-ivory mt-3">Live in four simple steps.</h2>
          </div>
          <ol className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {steps.map((s, i) => (
              <li key={s.title} className="relative">
                <span className="absolute -top-2 -left-2 z-10 w-7 h-7 rounded-full bg-[#0866FF] text-white text-xs font-bold flex items-center justify-center">{i + 1}</span>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Link to="/corporate-signup" className="inline-flex items-center gap-2 mt-8 bg-[#0866FF] hover:bg-[#0866FF] text-white font-semibold px-7 py-3.5 rounded-full text-sm transition-colors">
...
function Stat({ label, value }) {
  return (
    <div className="bg-[#F4F4F4] backdrop-blur-md rounded-xl px-4 py-3 text-left">
      <p className="text-[10px] uppercase tracking-wider text-[#0866FF]">{label}</p>
