  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold font-heading text-[#282828]">Partner Earnings & Bank Payouts</h1>
      ...
      <div className="bg-emerald-black ring-1 ring-[#F1F1F1] rounded-lg p-6 shadow-sm flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="font-extrabold text-[#282828] text-base">{bankName}</p>
            <p className="font-mono text-xs text-ivory-muted">{iban}</p>
          </div>
        </div>
      </div>

      <div className="bg-emerald-black ring-1 ring-[#F1F1F1] rounded-lg p-6 shadow-sm space-y-4">
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-emerald-black rounded-xl p-6 max-w-md w-full space-y-4 relative shadow-2xl">
            <div className="flex items-center justify-between border-b border-[#F1F1F1] pb-3">
              <h3 className="font-bold text-lg text-[#282828]">Update Bank Settlement Account</h3>
            ...
            <form onSubmit={handleBankSave} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full text-xs p-3 font-mono border border-[#F1F1F1] rounded-xl focus:border-[#F1F1F1] focus:outline-none"
                />
              </div>
              <button
                type="submit"
