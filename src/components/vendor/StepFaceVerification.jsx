  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        ...
        <h2 className="text-xl font-semibold text-gray-900">Take a quick selfie</h2>
        <p className="text-sm text-gray-500 mt-1.5 max-w-sm mx-auto">
          This is used only to match you with your uploaded ID and help prevent fraud.
        </p>
      </div>

      <ul className="text-sm text-gray-600 space-y-2 max-w-xs mx-auto">
      ...
      <div className="flex flex-col items-center gap-4">
        <div className="w-56 h-56 rounded-full bg-gray-50 border-2 border-dashed border-gray-200 flex items-center justify-center overflow-hidden">
          {form.selfie_url ? (
        ...
        <label className="cursor-pointer bg-gray-900 hover:bg-gray-800 text-white rounded-full px-6 py-3 text-sm font-semibold transition-all hover:-translate-y-0.5 hover:shadow-lg flex items-center gap-2">
