...
function Row({ label, value }) {
  ...
  return (
    <div className="flex justify-between text-sm py-1.5 border-b border-gray-50 last:border-0">
      ...
      <span className="text-ivory font-medium text-right max-w-[60%] truncate">{value}</span>
    </div>
  );
}
  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h2 className="text-xl font-semibold text-ivory">Review & Submit</h2>
        <p className="text-sm text-ivory-muted mt-1.5">Please confirm everything looks right before submitting.</p>
      </div>

      <div className="bg-[#f9f9fb] rounded-lg p-5">
        <p className="text-xs font-semibold text-ivory-dim uppercase tracking-wider mb-2">Business Information</p>
      ...
      <div className="bg-[#f9f9fb] rounded-lg p-5">
        <p className="text-xs font-semibold text-ivory-dim uppercase tracking-wider mb-2">Offer Details</p>
        <p className="text-sm text-ivory">{form.description}</p>
      ...
      <div className="bg-[#f9f9fb] rounded-lg p-5">
        <p className="text-xs font-semibold text-ivory-dim uppercase tracking-wider mb-3">Uploaded Documents</p>
      ...
      <label className="flex items-start gap-3 cursor-pointer">
        ...
        />
        <span className="text-sm text-ivory-muted">I confirm that I own or am authorized to represent this business.</span>
      </label>
