...
export default function StepVerification({ form, update, onNext, onBack }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <label className="text-sm font-medium text-ivory block mb-2">Choose a document to upload</label>
        <select
      ...
      <div className="space-y-2">
        <label className="text-sm font-medium text-ivory block">Government-issued ID</label>
        <UploadCard
      ...
      <div className="space-y-2">
        <label className="text-sm font-medium text-ivory block">
          Business Logo <span className="text-ivory-dim font-normal">(optional but recommended)</span>
        </label>
        <UploadCard
          label="Upload logo"
