  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        {apps.map((a) => (
          <div key={a.name} className="bg-emerald-black ring-1 ring-white/10 rounded-lg p-6 space-y-4 shadow-sm flex items-start justify-between">
            ...
            <button className={`px-4 py-2 rounded-xl text-xs font-bold ${
              a.connected ? "bg-[#0A3A2F] text-ivory" : "bg-[#0A3A2F]/5 text-ivory hover:bg-[#0A3A2F]/10"
            }`}>
