  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold font-heading text-[#282828]">Expense Claims & Reimbursements</h1>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3 bg-[#FFFFFF] p-4 rounded-lg border border-[#F1F1F1] shadow-sm">
        <div className="relative w-full sm:w-72">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 bg-[#F9F8F7] rounded-xl text-xs text-ivory focus:outline-none border border-transparent focus:border-[#F1F1F1]"
          />
        </div>
            ...
            {filtered.map((c) => (
              <tr key={c.id} className="hover:bg-[#F9F8F7] transition-colors">
                ...
                <td className="px-6 py-4 text-right space-x-2">
                  <button onClick={() => setSelectedClaim(c)} className="text-xs font-bold text-[#282828] hover:underline inline-flex items-center gap-1">
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-emerald-black rounded-xl p-6 max-w-md w-full shadow-2xl space-y-4">
            <div className="flex items-center justify-between border-b border-[#F1F1F1] pb-3">
              <h3 className="font-bold text-lg text-[#282828]">Review Claim #{selectedClaim.id}</h3>
            ...
            <div className="space-y-2 text-sm">
              ...
              <p><span className="font-bold text-ivory-muted">Amount:</span> <span className="font-extrabold text-[#282828]">${selectedClaim.amount.toFixed(2)}</span></p>
            ...
            {selectedClaim.status === "pending" ? (
              ...
              <div className="p-3 bg-[#F9F8F7] rounded-xl text-xs text-ivory-muted">
