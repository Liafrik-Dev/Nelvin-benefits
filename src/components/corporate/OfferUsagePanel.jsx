...
export default function OfferUsagePanel({ company, employees }) {
  ...
  return (
    <div>
      ...
      {loading ? (
        <div className="bg-emerald-black ring-1 ring-[#F1F1F1] rounded-lg p-12 text-center text-sm text-ivory-dim">Loading offer usage…</div>
      ) : redemptions.length === 0 ? (
        <div className="bg-emerald-black ring-1 ring-[#F1F1F1] rounded-lg p-12 text-center">
          <BarChart3 className="w-10 h-10 text-[#282828]/60 mx-auto mb-3" />
