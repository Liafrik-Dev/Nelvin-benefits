...
export default function GamificationHub() {
  ...
  return (
    <div className="bg-white border border-[#062B23]/10 rounded-lg p-6 shadow-sm space-y-6">
      {/* Header Banner */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <form onSubmit={handleSendKudos} className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <span className="inline-flex items-center gap-1.5 w-full text-xs font-semibold p-2.5 bg-white border border-slate-200 rounded-lg text-[#F5F1E8]">
        ...
        {/* Live Kudos Feed */}
        <div className="border border-[#062B23]/10 rounded-xl p-5 bg-white space-y-4">
