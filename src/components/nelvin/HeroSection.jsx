    ...
    <section className="relative min-h-screen flex flex-col overflow-hidden bg-black">
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-center sm:px-10 lg:px-16 px-6">
        ...
        <h1 className="font-heading font-bold text-white uppercase leading-[0.95] tracking-tight animate-fade-up-delay-1">
          <span className="block text-[clamp(2rem,9vw,6.5rem)]">Experience More.</span>
          <span className="block text-[clamp(2rem,9vw,6.5rem)] text-amber-400">Pay Less.</span>
        </h1>

        <p className="text-white/75 leading-relaxed max-w-md mt-6 lg:mt-8 animate-fade-up-delay-2 [font-family:'Bodoni_Moda',_serif] text-base sm:text-base">Unlock exclusive offers and premium savings from trusted businesses across Africa—all with one membership.
        ...
        <div className="flex items-center gap-2 mt-6 text-white/70 text-xs font-medium animate-fade-up-delay-3">
          ...
          Verified African Partner Network
        </div>
